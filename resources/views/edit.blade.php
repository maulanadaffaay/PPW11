                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('pegawai.update', $pegawai->id) }}" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="Nama" class="form-control @error('Nama') is-invalid @enderror" placeholder="Isi Nama Lengkap Anda" autocomplete="off" 
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="No_HP" class="form-control @error('No_HP') is-invalid @enderror" placeholder="Isi Email Anda" autocomplete="off" 
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="Alamat" class="form-control @error('Alamat') is-invalid @enderror" placeholder="Isi Waktu Kehadiran" autocomplete="off" 
